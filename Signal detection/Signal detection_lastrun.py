...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HP\\OneDrive\\Desktop\\Lab in Psych PSY310\\Signal detection\\Signal detection_lastrun.py',

...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HP\\OneDrive\\Desktop\\Lab in Psych PSY310\\Trial1_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    polygon = visual.ShapeStim(
        ...
        size=(5,5), vertices='triangle',
        ori=0.0, pos=(20, 10), anchor='center-right',
        lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor=[0.8824, 0.9451, 1.0000],
